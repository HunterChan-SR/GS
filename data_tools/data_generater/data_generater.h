 ...
 */
void generate_users_data(std::vector<UserData>& users, size_t size, uint64 seed = 0);
 ...
 * @param seed 随机数生成器种子
 */
void generate_users_data_range(std::vector<UserData>& users, size_t size, 
...
void bucketize_users_data(const std::vector<UserData> &users,
